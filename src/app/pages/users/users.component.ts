...
import { UsersTableComponent } from '../../shared/components/tables/basic-tables/users-table/users-table.component';
...
@Component({
  selector: 'app-users',
  standalone: true,
  imports: [ComponentCardComponent, UsersTableComponent, ButtonComponent, CommonModule, RouterLink, PageBreadcrumbComponent],
