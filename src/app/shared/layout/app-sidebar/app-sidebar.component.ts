...
// import { AuthService } from '../../../core/services/auth.service';   // ← Nouveau
...
//       subItems: [
//         { name: "users List", path: "/usersList", pro: false },
//       ],
//     },
...
//     return this.authService.isAdmin() ? this.adminNavItems : this.othersItems;
//   }
...
export class AppSidebarComponent implements OnInit {
  ...
  private adminNavItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2 4.25C2 3.00736 3.00736 2 4.25 2H19.75C20.9926 2 22 3.00736 22 4.25V14.75C22 15.9926 20.9926 17 19.75 17H13.5V18.5H15.25C15.6642 18.5 16 18.8358 16 19.25C16 19.6642 15.6642 20 15.25 20H8.75C8.33579 20 8 19.6642 8 19.25C8 18.8358 8.33579 18.5 8.75 18.5H10.5V17H4.25C3.00736 17 2 15.9926 2 14.75V4.25ZM3.5 4.25V12.5H20.5V4.25C20.5 3.83579 20.1642 3.5 19.75 3.5H4.25C3.83579 3.5 3.5 3.83579 3.5 4.25ZM20.5 14V14.75C20.5 15.1642 20.1642 15.5 19.75 15.5H4.25C3.83579 15.5 3.5 15.1642 3.5 14.75V14H20.5Z" fill="currentColor"></path></svg>`,
      name: "Applications",
      path: "/applications"
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`,
      name: "Gestion Utilisateurs",
      path: "/usersList"
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/><circle cx="12" cy="2" r="1" fill="currentColor" stroke="none"/></svg>`,
      name: "Logs Critiques",
      path: "/critical-logs"
    },
    {
  ...
  private userNavItems: NavItem[] = [
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 3.25C3 2.83579 3.33579 2.5 3.75 2.5H9.75C10.1642 2.5 10.5 2.83579 10.5 3.25V9.25C10.5 9.66421 10.1642 10 9.75 10H3.75C3.33579 10 3 9.66421 3 9.25V3.25ZM4.5 4V8.5H9V4H4.5ZM13.5 3.25C13.5 2.83579 13.8358 2.5 14.25 2.5H20.25C20.6642 2.5 21 2.83579 21 3.25V9.25C21 9.66421 20.6642 10 20.25 10H14.25C13.8358 10 13.5 9.66421 13.5 9.25V3.25ZM15 4V8.5H19.5V4H15ZM3 14.75C3 14.3358 3.33579 14 3.75 14H9.75C10.1642 14 10.5 14.3358 10.5 14.75V20.75C10.5 21.1642 10.1642 21.5 9.75 21.5H3.75C3.33579 21.5 3 21.1642 3 20.75V14.75ZM4.5 15.5V20H9V15.5H4.5ZM14.25 14C13.8358 14 13.5 14.3358 13.5 14.75V20.75C13.5 21.1642 13.8358 21.5 14.25 21.5H20.25C20.6642 21.5 21 21.1642 21 20.75V14.75C21 14.3358 20.6642 14 20.25 14H14.25ZM15 15.5H19.5V20H15V15.5Z" fill="currentColor"></path></svg>`,
...
ngOnInit() {
  ...
  this.subscription.add(
    this.currentRole$.subscribe((role: UserRole) => {
      this.navItems = role === 'ADMIN'
        ? this.adminNavItems
        : this.userNavItems;
    })
  );
  ...
  private setActiveMenuFromRoute(currentUrl: string) {
    // On utilise maintenant la liste dynamique navItems
